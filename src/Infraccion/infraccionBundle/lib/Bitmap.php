...
namespace Infraccion\infraccionBundle\lib;
...
class Bitmap
{
    ...
    public function __construct($pathname = "/tmp"){
    ...
    {
        /*** create a temp file ***/
        $tmp_name = tempnam($this->pathtemp, "GD");
        /*** convert to gd ***/
    ...
    public function convertJpg($bmp, $jpg)
    {
        $img = $this->imagecreatefrombmp($bmp);
        $ret = imagejpeg($img, $jpg,80);
        unlink($bmp);
