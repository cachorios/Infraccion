...
use Infraccion\infraccionBundle\Entity\Ubicacion;
use Infraccion\infraccionBundle\Form\UbicacionType;
use Infraccion\infraccionBundle\Form\UbicacionFilterType;
...
class UbicacionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $breadcrumbs->addItem("Ubicacion", $this->get("router")->generate("ubicacion"));
        list($filterForm, $queryBuilder) = $this->filter();

        list($entities, $pagerHtml) = $this->paginator($queryBuilder);

        return $this->render('InfraccionBundle:Ubicacion:index.html.twig', array(
            'entities' => $entities,
            'pagerHtml' => $pagerHtml,
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('InfraccionBundle:Ubicacion')->createQueryBuilder('e');
    ...
    */
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('InfraccionBundle:Ubicacion:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('InfraccionBundle:Ubicacion')->find($id);
        ...
        return $this->render('InfraccionBundle:Ubicacion:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('InfraccionBundle:Ubicacion:edit.html.twig', array(
            'entity'      => $entity,
